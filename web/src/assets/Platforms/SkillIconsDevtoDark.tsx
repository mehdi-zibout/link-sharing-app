...
const SvgSkillIconsDevtoDark = ({
  ...
  <svg
    ...
    className={className}
  >
    <g clipPath="url(#skill-icons_devto-dark_svg__a)">
      ...
      <path
        fill={
          className?.includes('fill-grey') ||
          className?.includes('fill-inherit')
            ? 'white'
            : '#333333'
        }
        fillRule="evenodd"
    ...
    <defs>
      <clipPath id="skill-icons_devto-dark_svg__a">
        <path d="M0 0h16v16H0z" />
      </clipPath>
    </defs>
  </svg>
)
export default SvgSkillIconsDevtoDark
